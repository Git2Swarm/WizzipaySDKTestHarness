...
public class MainActivity extends AppCompatActivity {
    ...
    AppCompatImageButton payment_full_screen_button_telegram,payment_full_screen_button_messanger,
            payment_full_screen_button_chrome,payment_full_screen_button_whatsup,
            payment_mini_screen_button_telegram,payment_mini_screen_button_messanger,
            payment_mini_screen_button_chrome,payment_mini_screen_button_whatsup;
